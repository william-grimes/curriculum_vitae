...
\sectionline
	...
	\ding{212} Developed and deployed a live system for the Netherlands Rijkswaterstaat transportation ministry using neural networks to predict the likelihood of road traffic accidents along Dutch highways.
